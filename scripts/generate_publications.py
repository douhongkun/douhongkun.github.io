...
pubs = [
    ...
    dict(
        ...
        citation='<strong>Dou, H.</strong>, et al. (2026). &quot;Plug-and-Play Guidance for Discrete Diffusion Models via Gradient-Informed Logit Correction.&quot; <i>ICML</i>.',
    ...
    dict(
        ...
        citation='Jiang, X., Gao, N., Zhang, X., <strong>Dou, H.</strong>, Fu, S., Zhong, X., Li, H., Deng, Y. (2026). &quot;Image Restoration via Multi-Domain Learning.&quot; <i>IEEE TPAMI</i>.',
    ...
    dict(
        ...
        citation='<strong>Dou, H.</strong>, et al. (2026). &quot;Constrained Particle Seeking: Solving Diffusion Inverse Problems with Just Forward Passes.&quot; <i>AAAI</i>.',
    ...
    dict(
        ...
        citation='Jiang, X., Gao, N., <strong>Dou, H.</strong>, et al. (2026). &quot;Global Modeling Matters: A Fast, Lightweight and Effective Baseline for Efficient Image Restoration.&quot; <i>IEEE TIP</i>. (JCR Q1 Top, IF: 13.7)',
    ...
    dict(
        ...
        venue="IEEE Transactions on Pattern Analysis and Machine Intelligence (TPAMI)",
        citation='<strong>Dou, H.</strong>, et al. (2025). &quot;You Only Look One Step: Accelerating Backpropagation in Diffusion Sampling with Gradient Shortcuts.&quot; <i>IEEE TPAMI</i>. (JCR Q1 Top, IF: 18.6)',
    ...
    dict(
        ...
        citation='Lu, J., Lin, J., <strong>Dou, H.</strong>, et al. (2025). &quot;DPoser-X: Diffusion Model as Robust 3D Whole-body Human Pose Prior.&quot; <i>ICCV</i> (Oral).',
    ...
    dict(
        ...
        citation='Liu, S., Gao, N., Gu, Z., <strong>Dou, H.</strong>, et al. (2025). &quot;Spatiotemporal Degradation-Aware 3D Gaussian Splatting for Realistic Underwater Scene Reconstruction.&quot; <i>ACM MM</i>.',
    ...
    dict(
        ...
        venue="IEEE Transactions on Image Processing (TIP)",
        citation='<strong>Dou, H.</strong>, et al. (2025). &quot;Image-to-Image Bayesian Flow Networks with Structurally Informative Priors.&quot; <i>IEEE TIP</i>. (JCR Q1 Top, IF: 13.7)',
    ...
    dict(
        ...
        citation='Wang, B., Zhang, Y., Li, H., <strong>Dou, H.</strong>, et al. (2025). &quot;Biologically inspired heterogeneous learning for accurate, efficient and low-latency neural network.&quot; <i>National Science Review</i>. (JCR Q1 Top, IF: 17.1)',
    ...
    dict(
        ...
        citation='<strong>Dou, H.</strong>, et al. (2025). &quot;Hybrid Regularization Improves Diffusion-based Inverse Problem Solving.&quot; <i>ICLR</i>.',
    ...
    dict(
        ...
        citation='Li, Z., <strong>Dou, H.</strong>, et al. (2025). &quot;Physics-aligned field reconstruction with diffusion bridge.&quot; <i>ICLR</i> (Spotlight).',
    ...
    dict(
        ...
        venue="International Conference on Learning Representations (ICLR)",
        citation='Jiang, X., Gao, N., Zhang, X., <strong>Dou, H.</strong>, et al. (2025). &quot;Value-aligned Behavior Cloning for Offline Reinforcement Learning via Bi-level Optimization.&quot; <i>ICLR</i>.',
    ...
    dict(
        ...
        citation='Fang, S., <strong>Dou, H.</strong>, et al. (2025). &quot;Expectation-Maximization-Based Optimization of Neural Quantum States for Ab Initio Quantum Chemistry.&quot; <i>JCTC</i>. (JCR Q1 Top, IF: 5.5)',
    ...
    dict(
        ...
        citation='<strong>Dou, H.</strong>, et al. (2025). &quot;High-dimensional Hyperparameter Optimization via Adjoint Differentiation.&quot; <i>IEEE TAI</i>.',
    ...
    dict(
        ...
        venue="IEEE Transactions on Artificial Intelligence (TAI)",
        citation='<strong>Dou, H.</strong>, et al. (2025). &quot;Towards a Unified Framework for Consistency Generative Modeling.&quot; <i>IEEE TAI</i>.',
    ...
    dict(
        ...
        citation='Yuan, H., <strong>Dou, H.</strong>, et al. (2024). &quot;Task-aware world model learning with meta weighting via bi-level optimization.&quot; <i>NeurIPS</i>.',
    ...
    dict(
        ...
        venue="IEEE Transactions on Image Processing (TIP)",
        citation='Liu, S., Lu, J., <strong>Dou, H.</strong>, et al. (2024). &quot;SEGSID: A Semantic-Guided Framework for Sonar Image Despeckling.&quot; <i>IEEE TIP</i>. (JCR Q1 Top, IF: 13.7)',
    ...
    dict(
        ...
        citation='Lu, J., He, G., <strong>Dou, H.</strong>, et al. (2023). &quot;ScoreSeg: Leveraging score-based generative model for self-supervised semantic segmentation of remote sensing.&quot; <i>IEEE JSTARS</i>. (IF: 5.3)',
    ...
    dict(
        ...
        citation='Jiang, X., <strong>Dou, H.</strong>, et al. (2022). &quot;Boosting supervised dehazing methods via bi-level patch reweighting.&quot; <i>ECCV</i>.',
    ...
    dict(
        ...
        citation='<strong>Dou, H.</strong>, et al. (2020). &quot;Residual D2NN: training diffractive deep neural networks via learnable light shortcuts.&quot; <i>Optics Letters</i>. (IF: 3.3)',
